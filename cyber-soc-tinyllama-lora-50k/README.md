...
| Field | Value |
|---|---|
| Adapter name | `cyber-soc-tinyllama-lora-50k` |
...
From the parent directory that contains `cyber-soc-tinyllama-lora-50k/`, run:

```bash
ls -lh cyber-soc-tinyllama-lora-50k
```
...
ADAPTER_DIR = "./cyber-soc-tinyllama-lora-50k"
...
ADAPTER_DIR = "./cyber-soc-tinyllama-lora-50k"
OUTPUT_DIR = "./cyber-soc-tinyllama-lora-50k-merged"
...
MODEL_DIR = "./cyber-soc-tinyllama-lora-50k-merged"
...
```bash
python convert_hf_to_gguf.py ../cyber-soc-tinyllama-lora-50k-merged \
  --outfile ../cyber-soc-tinyllama-lora-50k.gguf \
  --outtype f16
```
...
./build/bin/llama-quantize \
  ../cyber-soc-tinyllama-lora-50k.gguf \
  ../cyber-soc-tinyllama-lora-50k-q4_k_m.gguf \
  Q4_K_M
```
...
```text
FROM ./cyber-soc-tinyllama-lora-50k-q4_k_m.gguf
...
```bash
ollama create cyber-soc-tinyllama-lora-50k -f Modelfile
```

Run it interactively:

```bash
ollama run cyber-soc-tinyllama-lora-50k
```
...
curl http://localhost:11434/api/generate \
  -d '{
    "model": "cyber-soc-tinyllama-lora-50k",
